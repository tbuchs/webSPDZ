...
void callback_send_websocketplayer(void *args)
{
  struct args_websocket_send *a = (args_websocket_send *)args;
  int result = emscripten_websocket_send_binary(a->websocket_id, a->data_, a->msg_size_);
  if (result < 0)
  {
